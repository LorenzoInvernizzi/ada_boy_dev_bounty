...
"""
Problem 1. bounty: $100 in adaboy

1. Write a *nix executable that takes as an argument an integer N and returns the pair or tuple of Nth top adaboy holders' (address, balance)

e.g.

> ./my_soln.py 13

would print to stdout a response like

0x0a3d8365b5160b21fd1e98179b72d6d547487cba 1541186300.89
    ...
    try:
        ...
        for row in sel.css('tr'):
            ...
            if balance:  # skip rows with no percentage info
                ...
                list_holders.append((addr, balance/total_supply, balance))

        requested_holder = list_holders[sel_input_id_holder]
        print(requested_holder[0], requested_holder[2])
